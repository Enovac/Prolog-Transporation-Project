...
%Connected 10
connected(Source, Destination, Week, Day, Max_Duration, Max_Routes, Duration, Pre, R, Routes):-
	connected(Source, Destination, Week, Day, Max_Duration, Max_Routes, Duration, Pre,R, Routes, 0).
